...
if st.button("💬 Get Response"):
    if prompt_input.strip():
        full_prompt = (
            ...
            "of human beings if the input is not related to psychologist then write nothing"
            "and then two things you must have to add only when input is realted to mental health 1)how it can impact their mental health and "
            "2) Give prescriptions to improve their mental health in that situation. - don't finish "
            "your response without prescription manage tokens accordingly. -answer in depth words at least for a psychological input"
        )
        try:
